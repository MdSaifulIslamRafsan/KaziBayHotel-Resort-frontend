            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                    ...
                    <div className=" space-y-4">
                        {features.map((feature, index) => {
                            ...
                            return (<button
                                ...
                                className={cn(
                                    "w-full text-left p-6 rounded-2xl border transition-all duration-300 hover:shadow-md group",
                                    activeFeature === index
                    ...
                    <div className=" relative h-full">
                        <div className="relative rounded-3xl w-full h-full overflow-hidden shadow-xl  bg-muted">
                            <Image
                                src={currentImage}
