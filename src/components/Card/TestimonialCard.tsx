...
const TestimonialCard = ({ testimonial }: TestimonialCardProps) => {
  ...
  return (
    <Card className="h-full w-full flex flex-col border border-border bg-transparent hover:bg-primary/5 rounded-2xl shadow-md">
      <CardContent className="flex flex-col flex-1 w-full">
        ...
        {/* Review */}
        <p className="text-foreground/70 leading-6 flex-1 min-h-[100px]">
          {testimonial?.review}
        </p>
        ...
        <div className="flex items-center gap-4 mt-8">
          ...
          <div>
            <h4 className="font-serif md:text-lg ">{testimonial?.name}</h4>
