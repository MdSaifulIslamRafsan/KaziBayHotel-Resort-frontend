...
const FacilitiesCard = ({ amenity, index, showIndex }: AmenityCardProps) => {
  ...
  return (
    ...
    >
      <CardContent className="p-8">
        ...
        {showIndex && (
          <div className="absolute top-0 right-0 text-foreground/40 bg-primary/5 px-4 py-2 rounded-bl-md text-xl font-bold">
            {index + 1}
          </div>
        )}
